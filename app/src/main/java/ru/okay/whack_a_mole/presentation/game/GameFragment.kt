...
import ru.okay.whack_a_mole.data.model.Hole
import ru.okay.whack_a_mole.databinding.FragmentGameBinding
import ru.okay.whack_a_mole.presentation.game.adapter.HoleAdapter
import ru.okay.whack_a_mole.utils.Decorator
//Описываем UI
class GameFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //обращаемся к элементам интерфейса, которые описаны в верстке
        binding.apply {
